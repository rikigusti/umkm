...
<section>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div class="interactive-card overflow-hidden rounded-xl shadow-lg aspect-square">
            <img src="asset/images/sate ayam.png" alt="Foto Sate Ayam" class="w-full h-full object-cover">
        </div>
        <!-- Item Galeri 2: Soto -->
        <div class="interactive-card overflow-hidden rounded-xl shadow-lg aspect-square">
            <img src="asset/images/soto.jpeg" alt="Foto Semangkuk Soto" class="w-full h-full object-cover">
        </div>
        <!-- Item Galeri 3: Tumpeng -->
        <div class="interactive-card overflow-hidden rounded-xl shadow-lg aspect-square">
            <img src="asset/images/nasi tumpeng.png" alt="Foto Nasi Tumpeng" class="w-full h-full object-cover">
        </div>
        <!-- Item Galeri 4: Sambal -->
        <div class="interactive-card overflow-hidden rounded-xl shadow-lg aspect-square">
            <img src="asset/images/sambal.png" alt="Foto Aneka Sambal" class="w-full h-full object-cover">
        </div>
    </div>
</section>
